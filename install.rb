asset_mover_file = File.join(File.dirname(__FILE__), 'lib/plupload-rails3/asset_mover.rb')
...
if File.exists?(asset_mover_file) 
  ...
  require File.join(Rails.root, File.dirname(__FILE__), 'lib/plupload-rails3/asset_mover.rb')
end
